...
def molting_context(topic: str) -> str:
    ...
    results = molting_search(topic, n_results=8)
...
def molting_hypotheses() -> str:
    ...
    """
    # Search for hypothesis-related content
    results = molting_search("hypothesis H001 H002 H003 H004 H005 validated status", n_results=10)
...
def molting_experiments() -> str:
    ...
    """
    results = molting_search("experiment results VALIDATED findings setup test", n_results=10)
